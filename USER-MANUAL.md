...
| CivicClerk | 1.0.3 | meetings workflow | `civiccore` | `99f0da05ccd5` | `v1_0_3_city_core_release_car` |
| CivicCode | 1.0.8 | municipal code | `civiccore`, `civicclerk` | `656b42215c8c` | `v1_0_8_city_core_release_car` |
