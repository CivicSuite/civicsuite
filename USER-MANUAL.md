...
Today, multiple modules are shipping at different maturity levels: CivicRecords AI is production-usable, while CivicClerk, CivicCode, CivicZone, and CivicAccess have runtime-foundation releases. The rest are planned. We say so plainly below — no roadmap inflation, no vaporware.
