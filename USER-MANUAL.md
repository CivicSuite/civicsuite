...
| `civiccode` | Active productization `v0.1.16` municipal-code lane with durable section lifecycle, popular-question, staff-note, plain-language summary, CivicClerk handoff, handoff audit-event, import-job ledger, and related-material discovery aids |
...
```text
   ...
   | v1.4.10 shipping    |   | v0.1.20          |   | civicaccess ...  |
