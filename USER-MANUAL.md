...
| CivicClerk | 1.0.3 | meetings workflow | `civiccore` | `f6da40b7e469` | `v1_0_3_city_core_release_car` |
| CivicCode | 1.0.8 | municipal code | `civiccore`, `civicclerk` | `3cabf3947ced` | `v1_0_8_city_core_release_car` |
