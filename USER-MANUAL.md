...
|---|---:|---|---|---|---|
| CivicCore | 1.2.0 | shared platform | none | `f39f1afc76b7` | `v1_2_0_shared_ingestion_shipped` |
| CivicRecords AI | 1.7.3 | records workflow | `civiccore` | `59cabcbe5072` | `v1_7_3_city_core_release_car` |
| CivicClerk | 1.0.3 | meetings workflow | `civiccore` | `3bf5293dd6a0` | `v1_0_3_city_core_release_car` |
| CivicCode | 1.0.8 | municipal code | `civiccore`, `civicclerk` | `d2eaf1392c01` | `v1_0_8_city_core_release_car` |
