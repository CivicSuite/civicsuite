...
|---|---:|---|
| civiccore | v1.0.1 next | Real shared platform; patch release required, not demoted. |
| civicclerk | v1.0.1 next | Real meeting workflow; patch after the open-mode default fix, not demoted. |
| civicrecords-ai | v1.5.0 next | Developer preview; upgrade to CivicCore v1.0.0 before next release. |
...
- `civiccore` has real shared platform primitives, but v1.0.1 must reconcile release hygiene and downstream truth.
