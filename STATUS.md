...
The v1.0.1 UI gap is closed: Phase B ([PR #213](https://github.com/CivicSuite/civicsuite/pull/213)) wired the runtime, Phase C ([PR #214](https://github.com/CivicSuite/civicsuite/pull/214)) updated the module registry from five modules to six, and v1.0.2 shipped the clerk-facing **Accessibility** workflow tab in the desktop shell ([PR #216](https://github.com/CivicSuite/civicsuite/pull/216), mirroring the [CivicNotice precedent #193](https://github.com/CivicSuite/civicsuite/pull/193)).
