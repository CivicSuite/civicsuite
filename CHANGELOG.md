...
- **2026-05-21.** chore: CivicPlan v1.0.0 suite-truth reconciliation. CivicPlan [v1.0.0](https://github.com/CivicSuite/civicplan/releases/tag/v1.0.0) is now a recovered public-use module release after PR #11, main verify run `26229109178`, release workflow run `26229189252`, tag verify run `26229189480`, public browser QA, release-gate audit, release artifacts, and suite installer/module-selection reconciliation. This does not promote CivicPermit, CivicInspect, CivicGrants, CivicProcure, queued modules, the full suite, procurement readiness, production hosting certification, airgap readiness, live cross-module records exchange, or macOS lifecycle certification.
- **2026-05-21.** chore: CivicZone v1.0.0 suite-truth reconciliation. CivicZone [v1.0.0](https://github.com/CivicSuite/civiczone/releases/tag/v1.0.0) is now a recovered public-use module release after PR #18, main verify run `26225413750`, release workflow run `26225509133`, public/staff browser QA, release-gate audit, release artifacts, and suite installer/module-selection reconciliation. This does not promote CivicPlan, CivicPermit, CivicInspect, CivicGrants, CivicProcure, queued modules, the full suite, procurement readiness, production hosting certification, airgap readiness, live cross-module records exchange, or macOS lifecycle certification.
