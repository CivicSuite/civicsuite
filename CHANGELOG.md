...
- **CivicClerk v0.1.11 compatibility publication** (2026-05-01): compatibility matrix now records CivicClerk v0.1.11 as the published release on `civiccore v0.16.0` after the release workflow published the wheel, sdist, and checksum assets.
