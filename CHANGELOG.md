...
- **2026-05-21.** chore: CivicPermit v1.0.0 suite-truth reconciliation. CivicPermit [v1.0.0](https://github.com/CivicSuite/civicpermit/releases/tag/v1.0.0) is now a recovered public-use module release after PR #12, main verify run `26233364327`, release workflow run `26233455321`, tag verify run `26233454863`, public browser QA, release-gate audit, release artifacts, and suite installer/module-selection reconciliation. This does not promote CivicInspect, CivicGrants, CivicProcure, queued modules, the full suite, procurement readiness, production hosting certification, airgap readiness, live cross-module records exchange, or macOS lifecycle certification.
- **2026-05-21.** chore: CivicInspect v1.0.0 suite-truth reconciliation. CivicInspect [v1.0.0](https://github.com/CivicSuite/civicinspect/releases/tag/v1.0.0) is now a recovered public-use module release after PR #10, main verify run `26236492518`, release workflow run `26236555671`, tag verify run `26236555694`, public browser QA, release-gate audit, release artifacts, and suite installer/module-selection reconciliation. This does not promote CivicGrants, CivicProcure, queued modules, the full suite, procurement readiness, production hosting certification, airgap readiness, live cross-module records exchange, or macOS lifecycle certification.
- **2026-05-21.** chore: CivicPlan v1.0.0 suite-truth reconciliation. CivicPlan [v1.0.0](https://github.com/CivicSuite/civicplan/releases/tag/v1.0.0) is now a recovered public-use module release after PR #11, main verify run `26229109178`, release workflow run `26229189252`, tag verify run `26229189480`, public browser QA, release-gate audit, release artifacts, and suite installer/module-selection reconciliation. This was not a full-suite, procurement readiness, production hosting certification, airgap readiness, live cross-module records exchange, or macOS lifecycle certification claim.
- **2026-05-21.** chore: CivicZone v1.0.0 suite-truth reconciliation. CivicZone [v1.0.0](https://github.com/CivicSuite/civiczone/releases/tag/v1.0.0) is now a recovered public-use module release after PR #18, main verify run `26225413750`, release workflow run `26225509133`, public/staff browser QA, release-gate audit, release artifacts, and suite installer/module-selection reconciliation. This was not a full-suite, procurement readiness, production hosting certification, airgap readiness, live cross-module records exchange, or macOS lifecycle certification claim.
- **2026-05-21.** chore: CivicCode v1.0.0 suite-truth reconciliation. CivicCode [v1.0.0](https://github.com/CivicSuite/civiccode/releases/tag/v1.0.0) is now the first post-starter recovered public-use module release after PR #56/#57, main verify run `26219229208`, release workflow run `26219395141`, public browser QA, artifacts, attestation, and suite installer/module-selection reconciliation. This does not promote queued modules, the full suite, procurement readiness, production hosting certification, airgap readiness, live cross-module records exchange, or macOS lifecycle certification.
- **2026-05-21.** chore: CivicAccess v1.0.0 suite-truth reconciliation. CivicAccess [v1.0.0](https://github.com/CivicSuite/civicaccess/releases/tag/v1.0.0) is now a recovered public-use module release after PR #6, main verify run `26222780265`, release artifacts, public browser QA, release-gate audit, and suite installer/module-selection reconciliation. This does not promote queued modules, the full suite, procurement readiness, production hosting certification, airgap readiness, live cross-module records exchange, or macOS lifecycle certification.
