...
- **2026-05-21.** fix: release-integrity correction for six falsely promoted modules. CivicCode, CivicAccess, CivicZone, CivicPlan, CivicPermit, and CivicInspect are frozen for corrective demotion because their 2026-05-21 `v1.0.0` labels were published in error and did not satisfy the public-use module Definition of Done. Current suite truth is CivicCode `0.6.0`, CivicAccess `0.2.0`, and CivicZone/CivicPlan/CivicPermit/CivicInspect `0.2.1`; each false `v1.0.0` release must be superseded with a retraction note before Phase 0 can exit. This is a repair record only, not a product promotion, public-use release, queue advancement, full-suite readiness claim, procurement readiness claim, production hosting certification, airgap claim, live cross-module records exchange claim, or macOS lifecycle certification claim.
