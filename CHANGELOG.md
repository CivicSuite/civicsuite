...
- **2026-05-19.** docs: clerk-core beta.3 release gate package. The current published installer remains `installer-clerk-core-v0.1.0-beta.2`, but main now has newer PR #150/#153/#155 evidence. The next artifact decision is to publish `installer-clerk-core-v0.1.0-beta.3` only after a `release-tag` PR passes release-lockstep and main CI; this is an unsigned OSS beta decision, not a public-use, city-ready, procurement-ready, live cross-module exchange, or macOS lifecycle certification claim.
