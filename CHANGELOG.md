...
- **2026-05-27.** ci: close city-core PR evidence loop. PR #183 is green at `8ee2c59` for verify run `26486410138`, release-lockstep-gate run `26486410136`, and installer-cleanroom run `26486410137`, including Linux lifecycle for clerk-core and city-core archives plus Windows readiness and macOS beta readiness. CivicRecords AI PR #100 is green at `d7f84a3` for CI run `26487863170`. At this checkpoint the remaining promotion caveats were first-run browser QA and audit-full; this still did not claim public-use readiness, city-ready status, procurement readiness, production readiness, macOS lifecycle certification, or full-suite release.
