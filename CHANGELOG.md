...
- **2026-05-28.** chore(installer): update city-core `source_commit` pins for the real non-technical-release engagement branches. CivicCore now pins to `e3344c6d861f4482ffa518eea6ffed17ef391bca`, CivicRecords AI to `d3adde5a1106c1586e576d8ff98b528db44d9043`, CivicClerk to `ef08cbe512bc0ec1adb187c4967bcd888379a428`, and CivicCode to `84e5cdaceff5d82facf8abdc9700a3d91a717fe8` for local vendored-source verification without changing the already-published release objects. The installer-cleanroom workflow checks out those same source roots so CI packaging and `installer/modules.json` stay in lockstep.
