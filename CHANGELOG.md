...
- **2026-05-28.** test(auth): add a city-core suite-session contract test that issues one CivicCore token, validates it through Records AI, CivicClerk, and CivicCode adapters, then revokes it once through the shared revocation file. The CivicCode fixture now uses the searchable `CIVICCORE_SUITE_SESSION_SECRET` literal, and the CivicCode branch pin advances to `656b42215c8c04527a39ff80ae67fe653dbdeaf9`.
- **2026-05-28.** chore(installer): update city-core `source_commit` pins for the real non-technical-release engagement branches. CivicCore now pins to `90ec5417d37d469f2cf01d26ace393f67504a805`, CivicRecords AI to `76440b3818e8d39b6ecafee61daefd3fa88f239f`, CivicClerk to `99f0da05ccd5dbb4e96d4f51ecefa1f5c90efac1`, and CivicCode to `656b42215c8c04527a39ff80ae67fe653dbdeaf9` for local vendored-source verification without changing the already-published release objects. The installer-cleanroom workflow checks out those same source roots so CI packaging and `installer/modules.json` stay in lockstep.
