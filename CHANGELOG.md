...
- **2026-06-01.** fix(installer): continue Stage 2 live installer audit closure at head `c87aa3e` by making the city-core workflow proof require model-generated Records AI response letters, failing hard on Ollama model-load errors, binding existing-stack verification to install provenance, hardening streamed lifecycle process exit handling, raising the local-AI readiness RAM floor to 12 GB for `gemma4:e4b`, and pinning CivicRecords AI source to `523e7db431fc5d6168f1ad30d32e227d36f00e49` for the generation-provenance API. No merge, tag, status promotion, or public-use/procurement/production claim is made by this entry.
