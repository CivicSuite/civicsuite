...
Current count: 27 product modules plus the CivicCore shared platform. The
original catalog established the first 25 product modules and CivicCore; the
2026-04-30 addendum adds planned CivicRegWatch and CivicAPI modules and the
reconciled catalog names 27 product modules after CivicCore. Their
