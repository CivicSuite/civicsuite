...
- Audit CivicCore, CivicSunshine, CivicMeetings, and the CivicSuite installer against the specification.
- Finish the clerk-core installer lifecycle for install, start, health, repair, backup, restore, and uninstall.
- Prove CivicSunshine request, search, review, and response workflows inside the installed stack.
- Prove CivicMeetings agenda, packet, minutes, vote, notice, and archive workflows inside the installed stack.
- Prove CivicMeetings optional CivicSunshine visibility where supported.
...
- CivicCore, CivicSunshine, CivicMeetings, and installer gaps are converted into tracked slices with acceptance checks.
