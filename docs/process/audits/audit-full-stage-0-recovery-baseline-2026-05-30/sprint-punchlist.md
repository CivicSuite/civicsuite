...
- Installer-cleanroom stale CivicCode checkout ref: fixed in `C:\dev\Claude\CivicSuite-live-install-fix-2026-05-29\.github\workflows\installer-cleanroom.yml`.
- Lockstep verifier artifact missing from truth set: fixed in `C:\dev\Claude\CivicSuite-live-install-fix-2026-05-29\scripts\verify-suite-state.py`.
- Stale user-manual topology block: fixed in `C:\dev\Claude\CivicSuite-live-install-fix-2026-05-29\USER-MANUAL.md`.
