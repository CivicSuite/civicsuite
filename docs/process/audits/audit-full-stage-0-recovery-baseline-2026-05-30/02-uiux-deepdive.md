...
- The hook failure messages in `C:\dev\Claude\CivicSuite-live-install-fix-2026-05-29\scripts\hooks\pre-push.ps1` are specific and actionable: dirty tree, direct default-branch push, missing Stage 0 baseline, or invalid HEAD SHA.
