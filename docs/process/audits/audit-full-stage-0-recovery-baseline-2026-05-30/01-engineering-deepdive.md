...
- `python scripts\policy\check_workflow_cost_ledger.py --run 2026-05-30-stage-0-recovery-baseline` returned PASS with ledger `C:\Users\scott\OneDrive\Desktop\Claude\CivicSuite-live-install-fix-2026-05-29\.agent-runs\2026-05-30-stage-0-recovery-baseline\workflow-cost-ledger.md`.
