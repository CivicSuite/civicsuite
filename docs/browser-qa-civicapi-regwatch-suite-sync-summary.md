# Browser QA - CivicAPI/CivicRegWatch Suite Docs Sync
...
- Desktop viewport `1440x1000`: `docs/browser-qa-civicapi-regwatch-desktop.png`
- Mobile viewport `500x844`: `docs/browser-qa-civicapi-regwatch-mobile.png`
