...
|-----------------|--------------------------------|-----------------|------------|----------------------------|---------------|-------|
| civiccore       | Townlight/civiccore           | 1.2.0           | 2026-05-23 | n/a                        | 2026-06-13    | Shared document-ingestion pipeline release; now includes Windows-local platform contracts and PostgreSQL-backed local task queue/worker. |
| civicrecords-ai | Townlight/civicrecords-ai     | 1.7.3           | 2026-05-23 | `==1.2.0`                  | 2026-05-25    | City-core records module release consuming CivicCore shared ingestion; v1.7.3 adds release-asset convention bring-up without installer behavior changes. |
| civicclerk      | Townlight/civicclerk          | 1.0.4           | 2026-06-13 | `==1.2.0`                  | 2026-06-13    | City-core clerk module release with persistence refresh and protected staff auth defaults retained. |
| civicregwatch   | Townlight/civicregwatch       | planned         | not released | TBD                      | 2026-04-30    | New planned federal regulatory intelligence module. Implementation spec exists in `specs/05_civicregwatch.md`; repo and civiccore pin are not scaffolded yet. |
| civicapi        | Townlight/civicapi            | planned         | not released | TBD                      | 2026-04-30    | New planned public read-only data gateway module. Implementation spec exists in `specs/06_civicapi.md`; repo and civiccore pin are not scaffolded yet. |
| civiccode       | Townlight/civiccode           | 1.0.8           | 2026-05-23 | `==1.2.0`                  | 2026-05-23    | City-core municipal-code module release; v1.0.8 supersedes v1.0.0 and consumes CivicCore shared ingestion. |
| civiczone       | Townlight/civiczone           | 0.2.2           | 2026-05-23 | `==1.1.0`                  | 2026-05-23    | Early scaffold; version label corrected to match actual maturity; full build queued for Tier 2. |
| civicaccess     | Townlight/civicaccess         | 0.4.0           | 2026-06-28 | `==1.2.0`                  | 2026-07-02    | Sixth city-core module: accessibility + records-ready export release on CivicCore v1.2.0, bundled in the Windows-Local city-core MSI as of v1.0.2 with real local-AI accessibility features (plain-language rewrite, translation, advisory review analysis). A follow-up in-depth review (2026-06-29) qualified it for city-core, reversing the 2026-05-23 "needs work" demotion (a failed depth review). |
| civicplan       | Townlight/civicplan           | 0.2.2           | 2026-05-23 | `==1.1.0`                  | 2026-05-23    | Early scaffold; version label corrected to match actual maturity; full build queued for Tier 2. |
| civicpermit     | Townlight/civicpermit         | 0.2.2           | 2026-05-23 | `==1.1.0`                  | 2026-05-23    | Early scaffold; version label corrected to match actual maturity; full build queued for Tier 2. |
| civicinspect    | Townlight/civicinspect        | 0.2.2           | 2026-05-23 | `==1.1.0`                  | 2026-05-23    | Early scaffold; version label corrected to match actual maturity; full build queued for Tier 2. |
| civicgrants     | Townlight/civicgrants         | 0.2.0           | 2026-05-10 | `==1.1.0`                  | 2026-05-11    | D2/B3 rollout consumes CivicCore v1.1.0 shared `staff_key_gate`; module remains scaffold-depth, not v1.0 product-ready. |
| civicprocure    | Townlight/civicprocure        | 0.2.0           | 2026-05-10 | `==1.1.0`                  | 2026-05-11    | D2/B3 rollout consumes CivicCore v1.1.0 shared `staff_key_gate`; module remains scaffold-depth, not v1.0 product-ready. |
| civiccontracts  | Townlight/civiccontracts      | 0.1.1           | 2026-04-28 | `==0.3.0`                  | 2026-04-28    | Dependency-alignment release: contract repository foundation preserved while moving to civiccore 0.3.0 shared primitives. |
| civicboards     | Townlight/civicboards         | 0.1.1           | 2026-04-28 | `==0.3.0`                  | 2026-04-28    | Dependency-alignment release: board administration foundation preserved while moving to civiccore 0.3.0 shared primitives. |
| civicnotice     | Townlight/civicnotice         | 0.2.0           | 2026-06-19 (tag); release published 2026-07-03 | `==1.2.0`     | 2026-07-03    | City-core public-notice module release with checklist, posting proof, archive export, backup/restore, and Windows Local installer integration. The [v0.2.0 release](https://github.com/townlight/notice/releases/tag/v0.2.0) is published from the 2026-06-19 tag. |
| civic311        | Townlight/civic311            | 0.1.1           | 2026-04-28 | `==0.3.0`                  | 2026-04-28    | Dependency-alignment release: resident service request foundation preserved while moving to civiccore 0.3.0 shared primitives. |
| civiccomms      | Townlight/civiccomms          | 0.1.1           | 2026-04-28 | `==0.3.0`                  | 2026-04-28    | Dependency-alignment release: public communications foundation preserved while moving to civiccore 0.3.0 shared primitives. |
| civicdata       | Townlight/civicdata           | 0.1.2           | 2026-04-29 | `==0.4.0`                  | 2026-04-29    | Auth-protected persisted retrieval rollout consumes the published `civiccore v0.4.0` release. |
| civichr         | Townlight/civichr             | 0.1.1           | 2026-04-28 | `==0.3.0`                  | 2026-04-28    | Dependency-alignment release: HR policy support foundation preserved while moving to civiccore 0.3.0 shared primitives. |
| civicbudget     | Townlight/civicbudget         | 0.1.2           | 2026-04-29 | `==0.4.0`                  | 2026-04-29    | Auth-protected persisted retrieval rollout consumes the published `civiccore v0.4.0` release. |
| civiclegal      | Townlight/civiclegal          | 0.1.2           | 2026-04-29 | `==0.11.0`                 | 2026-04-29    | Privilege-aware search/access filtering now consumes the published `civiccore v0.11.0` release wheel. |
| civicelections  | Townlight/civicelections      | 0.1.1           | 2026-04-28 | `==0.3.0`                  | 2026-04-28    | Dependency-alignment release: election administration support foundation preserved while moving to civiccore 0.3.0 shared primitives. |
| civicutility    | Townlight/civicutility        | 0.1.1           | 2026-04-28 | `==0.3.0`                  | 2026-04-28    | Dependency-alignment release: utility support foundation preserved while moving to civiccore 0.3.0 shared primitives. |
| civiccourt      | Townlight/civiccourt          | 0.1.2           | 2026-04-29 | `==0.4.0`                  | 2026-04-29    | Auth-protected persisted retrieval rollout consumes the published `civiccore v0.4.0` release. |
| civicsafety     | Townlight/civicsafety         | 0.1.1           | 2026-04-28 | `==0.3.0`                  | 2026-04-28    | Dependency-alignment release: public-safety administrative support foundation preserved while moving to civiccore 0.3.0 shared primitives. |
| civiclibrary    | Townlight/civiclibrary        | 0.1.1           | 2026-04-28 | `==0.3.0`                  | 2026-04-28    | Dependency-alignment release: library support foundation preserved while moving to civiccore 0.3.0 shared primitives. |
| civicparks      | Townlight/civicparks          | 0.1.1           | 2026-04-28 | `==0.3.0`                  | 2026-04-28    | Dependency-alignment release: parks and recreation support foundation preserved while moving to civiccore 0.3.0 shared primitives. |
