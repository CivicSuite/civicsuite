...
| civiccode       | CivicSuite/civiccode           | 0.1.7           | 2026-05-03 | `==0.21.0`                 | 2026-05-03    | Active municipal-code productization release: source-registry persistence, staff-header-protected source registry operations, the staff source registry workspace, the staff code lifecycle workspace, reusable mock-city codifier contracts, and staff-controlled codifier live-sync readiness are published while the module consumes the published `civiccore v0.21.0` wheel. |
