...
| civicrecords-ai | CivicSuite/civicrecords-ai     | 1.4.3           | 2026-04-30 | `==0.13.0`                 | 2026-04-30    | Current local records-ai backend pins the published `civiccore v0.13.0` wheel. |
| civicclerk      | CivicSuite/civicclerk          | 0.1.11          | 2026-04-30 | `==0.16.0`                 | 2026-04-30    | Productizing clerk release line consumes `civiccore v0.16.0` for packet exports, connector runtime validation helpers, trusted-header config/proxy enforcement, browser evidence verification, and deployment hardening. |
...
| civicnotice     | CivicSuite/civicnotice         | 0.1.2           | 2026-04-29 | `==0.9.0`                  | 2026-04-30    | Current local notice release line consumes `civiccore v0.9.0` for notice-compliance helper reuse. |
...
`civicrecords-ai 1.4.3 ... ==0.13.0` means: records-ai version 1.4.3 requires
exactly civiccore 0.13.0. Mixing other civiccore versions with that
