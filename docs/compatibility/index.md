...
| civicnotice     | CivicSuite/civicnotice         | 0.2.0           | tag 2026-06-19; GitHub release pending | `==1.2.0`     | 2026-06-19    | City-core public-notice release car with checklist, posting proof, archive export, backup/restore, and Windows Local installer integration. v0.2.0 is a git tag only — no published GitHub release yet; latest published release is v0.1.1. |
