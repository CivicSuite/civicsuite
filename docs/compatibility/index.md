...
| civiccode       | CivicSuite/civiccode           | 1.0.0           | 2026-05-21 | `==1.1.0`                  | 2026-05-21    | Public-use module release passed source release gates, public browser QA, v1.0.0 release workflow, artifacts, attestation, and suite installer/module-selection truth reconciliation. |
| civiczone       | CivicSuite/civiczone           | 1.0.0           | 2026-05-21 | `==1.1.0`                  | 2026-05-21    | Public-use module release passed source release gates, public/staff browser QA, release-gate audit, v1.0.0 release workflow, artifacts, and suite installer/module-selection truth reconciliation. |
| civicaccess     | CivicSuite/civicaccess         | 1.0.0           | 2026-05-21 | `==1.1.0`                  | 2026-05-21    | Public-use module release passed source release gates, public browser QA, release-gate audit, artifacts, and suite installer/module-selection truth reconciliation. |
...
| 2026-05-21 | 1.1.0     | civicaccess 1.0.0      | green  | CivicAccess PR #6 merged; main verify run `26222780265` passed; tag `v1.0.0` peels to `e29e701d96817a1aaca053ae8979851d9fb9dc51`; GitHub release published wheel, sdist, and SHA256SUMS assets after public browser QA and release-gate audit. |
