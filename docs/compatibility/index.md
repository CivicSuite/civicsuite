...
| civiccode       | CivicSuite/civiccode           | 0.1.2           | 2026-05-02 | `==0.19.0`                 | 2026-05-02    | Shared-platform alignment release: source-registry persistence is published while the module consumes the published `civiccore v0.19.0` wheel. |
...
|------------|-----------|------------------------|--------|----------|
| 2026-05-02 | 0.19.0    | civiccode 0.1.2        | green  | civiccode PR #23 merged at c66ffd5; post-release copy cleanup PR #24 merged at b4840ff; `bash scripts/verify-release.sh` passed with 109 tests, docs gate, placeholder import gate, Ruff, and build artifact checks; main CI run 25251738252 passed; GitHub release `v0.1.2` published wheel, sdist, and SHA256SUMS assets |
