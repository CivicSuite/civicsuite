...
| civiccode       | CivicSuite/civiccode           | 0.1.5           | 2026-05-02 | `==0.19.0`                 | 2026-05-02    | Active municipal-code productization release: source-registry persistence, staff-header-protected source registry operations, the staff source registry workspace, and the staff code lifecycle workspace are published while the module consumes the published `civiccore v0.19.0` wheel. |
