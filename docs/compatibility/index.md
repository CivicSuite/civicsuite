...
| civicclerk      | CivicSuite/civicclerk          | 0.1.11          | 2026-05-01 | `==0.16.0`                 | 2026-05-01    | Productizing clerk release consumes the published `civiccore v0.16.0` wheel and includes live staff cockpit panels, deployment preflight, fresh-install rehearsal, backup/restore rehearsal, and release handoff helpers. |
...
|------------|-----------|------------------------|--------|----------|
| 2026-05-01 | 0.16.0    | civicclerk 0.1.11      | green  | civicclerk PR #77 merged at 14830d4; release workflow run 25199278136 passed verify-release.sh and published wheel, sdist, and SHA256SUMS assets for v0.1.11 |
