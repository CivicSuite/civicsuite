...
|-----------------|--------------------------------|-----------------|------------|----------------------------|---------------|-------|
| civiccore       | CivicSuite/civiccore           | 0.17.0          | 2026-05-01 | n/a                        | 2026-05-01    | Shared platform release line now includes persisted audit-log hash/verification helpers in addition to connector import helpers, browser-evidence verification helpers, shared search/access helpers, trusted-header config loading, and proxy-source enforcement helpers. |
| civicrecords-ai | CivicSuite/civicrecords-ai     | 1.4.4           | 2026-05-01 | `==0.17.0`                 | 2026-05-01    | Published records-ai release consumes the published `civiccore v0.17.0` wheel for persisted audit-log hashing and verification, plus shared search, onboarding, connector-security, and ingest contracts. |
| civicclerk      | CivicSuite/civicclerk          | 0.1.12          | 2026-05-01 | `==0.16.0`                 | 2026-05-01    | Productizing clerk release consumes the published `civiccore v0.16.0` wheel and includes the React staff/public product rehearsal, Docker Compose seeded demo, OIDC browser-session foundation, Docker/PostgreSQL backup/restore rehearsal, scheduled local connector import sync, installer source packaging, and enterprise signing readiness. |
...
| 2026-05-01 | 0.16.0    | civicclerk 0.1.12      | green  | civicclerk main at 77599cb; PR #108 merged; `bash scripts/verify-release.sh` passed; GitHub release `v0.1.12` published wheel, sdist, and SHA256SUMS assets |
