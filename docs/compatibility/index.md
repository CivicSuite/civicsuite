...
| civicclerk      | CivicSuite/civicclerk          | 0.1.15          | 2026-05-02 | `==0.18.1`                 | 2026-05-02    | Productizing clerk release consumes the published `civiccore v0.18.1` wheel and includes the React staff/public product rehearsal, Docker Compose seeded demo, OIDC browser-session foundation, Docker/PostgreSQL backup/restore rehearsal, vendor-network live sync using shared CivicCore retry/circuit primitives, scheduled local connector import sync, installer source packaging, and enterprise signing readiness. |
