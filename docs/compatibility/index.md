...
|-----------------|--------------------------------|-----------------|------------|----------------------------|---------------|-------|
| civiccore       | CivicSuite/civiccore           | 1.0.0           | 2026-05-05 | n/a                        | 2026-05-07    | Public v1 tag exists; recovery status is provisional. Shared-platform code and downstream contract claims must be re-verified before this row is used as a product-readiness or stability claim. |
...
| civicclerk      | CivicSuite/civicclerk          | 1.0.0           | 2026-05-06 | `==1.0.0`                  | 2026-05-07    | Public v1.0.0 tag exists; recovery status is provisional. Meeting workflow, frontend separation, OIDC, vendor sync, backup/restore, and integration-depth claims require real user-flow, install, security, and mock-vs-production proof before promotion. |
...
| civiccode       | CivicSuite/civiccode           | 1.0.0           | 2026-05-07 | `==1.0.0`                  | 2026-05-07    | Public v1.0.0 tag exists after local recovery work; recovery status is provisional until repo-specific audit, runtime user-flow proof, install proof, security scans, and mock-vs-production labeling pass. |
| civiczone       | CivicSuite/civiczone           | 1.0.0           | 2026-05-07 | `==1.0.0`                  | 2026-05-07    | Public v1.0.0 tag exists after local recovery work; recovery status is provisional until repo-specific audit, runtime user-flow proof, install proof, security scans, and mock-vs-production labeling pass. |
...
| civicplan       | CivicSuite/civicplan           | 1.0.0           | 2026-05-07 | `==1.0.0`                  | 2026-05-07    | Public v1.0.0 tag exists after local recovery work; recovery status is provisional until repo-specific audit, runtime user-flow proof, install proof, security scans, and mock-vs-production labeling pass. |
| civicpermit     | CivicSuite/civicpermit         | 1.0.0           | 2026-05-07 | `==1.0.0`                  | 2026-05-07    | Public v1.0.0 tag exists after local recovery work; recovery status is provisional until repo-specific audit, runtime user-flow proof, install proof, security scans, and mock-vs-production labeling pass. |
| civicinspect    | CivicSuite/civicinspect        | 1.0.0           | 2026-05-09 | `==1.0.0`                  | 2026-05-09    | Inspection support productization with staff review queues, CivicCode/context packets, adversarial local mocks, browser QA, release evidence, and installer selection proof. |
| civicgrants     | CivicSuite/civicgrants         | 1.0.0           | 2026-05-09 | `==1.0.0`                  | 2026-05-09    | Grant support productization with staff review queues, CivicRecords/grant-file context packets, adversarial local mocks, browser QA, release evidence, and installer selection proof. |
| civicprocure    | CivicSuite/civicprocure        | 1.0.0           | 2026-05-09 | `==1.0.0`                  | 2026-05-09    | Procurement support productization with staff review queues, CivicClerk/CivicContracts context packets, adversarial local mocks, browser QA, release evidence, and installer selection proof. |
...
| 2026-05-05 | 1.0.0     | civiccore 1.0.0        | green  | civiccore release `v1.0` is the current shared-platform release; release assets publish `civiccore-1.0.0` wheel and source distribution after CO-9 closeout and evidence-manifest hash refresh. |
