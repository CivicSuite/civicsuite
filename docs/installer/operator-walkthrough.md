...
- Records Requests: create or submit a request, review the response deadline and basis, record search/citation notes, generate or type a response draft, approve, export, mark fulfilled, and close.
