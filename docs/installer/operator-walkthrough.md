...
- Records Requests: create or submit a request, review the response deadline and basis, review the Request Timeline and Notification Outbox, log generated notifications as sent after staff sends them, record search/citation notes, generate or type a response draft, approve, export, mark fulfilled, and close.
