...
Do not use for demoted modules: "v1.0.0", "product-ready", "city-ready", "shipping product", "production-usable", or "done". CivicCode and CivicAccess are no longer in the demoted-module set after their 2026-05-21 v1.0.0 release gates.
