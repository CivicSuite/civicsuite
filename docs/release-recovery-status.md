...
| civicclerk | v1.0.1 | v1.0.3 shipped | Real product-shaped meeting workflow release car pinned to CivicCore v1.2.0; protected staff auth defaults remain required. |
