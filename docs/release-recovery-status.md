...
| civicrecords-ai | v1.6.1 | v1.7.1 shipped | Developer-preview records release car pinned to CivicCore v1.2.0 and consuming shared CivicCore ingestion. |
...
- **2026-05-23:** city-core release-train truth supersedes the false post-starter sweep. CivicCore v1.2.0, CivicRecords AI v1.7.1, CivicClerk v1.0.3, and CivicCode v1.0.8 are the city-core cars. CivicAccess is OUT after a NEEDS-WORK depth probe. CivicZone, CivicPlan, CivicPermit, and CivicInspect have no-functional-upgrade v0.2.2 demotion releases as Latest. City-core remains beta-ready until installer packaging, live integration proof, secrets/config gates, compatibility matrix, and independent audit clear.
