...
- **2026-05-19:** The clerk-core beta.3 release-gate package records the artifact decision after main verify run `26116871355` and installer-cleanroom run `26116871385`: the current public release remains `installer-clerk-core-v0.1.0-beta.2` until a `release-tag` PR publishes `installer-clerk-core-v0.1.0-beta.3` with updated SHA256 artifacts and green release-lockstep. Beta.3 may be described as an unsigned OSS beta for outside testing only; it must not be described as public-use ready, city-ready, procurement-ready, live cross-module records exchange, or macOS lifecycle certification.
