...
- **2026-05-20:** the Clerk-Core public-use readiness gate was recorded at `docs/installer/starter-set-public-use-readiness-gate.md`. The gate maps beta.4 evidence to the recovery checklist and remains RED until independent audit of the 2026-05-20 route/state/adversarial evidence, any required gap fixes, current per-repo checks, final promotion docs/release-truth, independent release-gate audit, and fresh CI evidence are recorded.
- **2026-05-20:** installed Clerk-Core route/state evidence was added under `docs/installer/browser-qa/2026-05-20-clerk-core-public-use-matrix.md` and `.json`, with screenshots for CivicRecords AI login/dashboard/search/request paths and CivicClerk public/staff/protected-state paths. The matrix records 20 browser checks, 157 installed routes, desktop/mobile coverage, loading/success/empty/error/partial state checks where supported, adversarial local integration probes, and restore-precondition behavior for a missing backup manifest. This is audit evidence for the still-RED public-use gate; it does not promote beta.4 to public-use, city-ready, production-ready, procurement-ready, live cross-module exchange, or macOS lifecycle certification status.
