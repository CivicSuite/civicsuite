...
- **2026-05-20:** the Clerk-Core public-use readiness gate was recorded at `docs/installer/starter-set-public-use-readiness-gate.md`. The gate maps beta.4 evidence to the recovery checklist and remains RED until route/state QA, adversarial integration mocks, current per-repo checks, final promotion docs, independent release-gate audit, and fresh CI evidence are recorded.
