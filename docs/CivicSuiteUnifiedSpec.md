...
As of 2026-05-27, the city-core profile has implementation evidence for non-technical Windows and Linux installability with CivicCore v1.2.0, CivicRecords AI v1.7.3, CivicClerk v1.0.3, and CivicCode v1.0.8. The vendored-source installer artifacts remain installer version `0.1.2`; the evidence covers one-click wrapper smoke, Guided/Manual Docker prerequisite setup paths, first-run wizard smoke, 60 GB cleanroom hygiene, and local Windows/Linux matching-host lifecycle runs under `C:\Users\scott\OneDrive\Desktop\Claude\CivicSuite-city-core-caboose-item1\.agent-runs\2026-05-26-city-core-non-technical-installable\`. PR #183 is green at `8ee2c59` for verify run `26486410138`, release-lockstep-gate run `26486410136`, and installer-cleanroom run `26486410137`. The honest state is Implemented, pending first-run browser QA and audit-full. This does not create public-use readiness, city-ready status, procurement readiness, production readiness, macOS lifecycle certification, or a full-suite release claim.
