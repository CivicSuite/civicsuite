...
- All 26 catalog modules have runtime-foundation releases; CivicCode, CivicZone, CivicAccess, CivicPlan, CivicPermit, and CivicInspect have advanced to v0.1.1 for CivicCore v0.3.0 alignment, while the remaining module releases stay pinned as recorded in the compatibility matrix. Remaining work is post-foundation depth, connectors, deployment hardening, and cross-module UX.
