...
| civicclerk | 1.0.3 | 1.2.0 | 99f0da05ccd5dbb4e96d4f51ecefa1f5c90efac1 | Real meeting workflow release car with protected staff auth defaults retained, branch-level bearer handoff/session contracts, and a retry-hardened frontend dependency-audit gate. |
| civiccode | 1.0.8 | 1.2.0 | 656b42215c8c04527a39ff80ae67fe653dbdeaf9 | City-core municipal-code release car; v1.0.8 supersedes v1.0.0, consumes CivicCore shared ingestion, and branch-level staff APIs require shared bearer sessions. |
