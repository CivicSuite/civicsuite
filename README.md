...
- City-core generated package surfaces exist under the installer tree. The current canonical 0.1.2 artifacts for this run are preserved under `C:\Users\scott\OneDrive\Desktop\Claude\CivicSuite-city-core-caboose-item1\.agent-runs\2026-05-26-city-core-non-technical-installable\evidence\current-0.1.2-build-regenerated-2026-05-27-windows-admin-email-fix`; PR #183 has green verify, release-lockstep-gate, and installer-cleanroom checks. Exact volatile PR run IDs are recorded in the PR body and run evidence. Release promotion still requires final audit-full evidence.
