...
CivicZone v0.1.0 now ships. CivicAccess is the next planned Clerk Core module
lane, with CivicPlan and other Tier 2 land-use modules following after the
foundation modules stabilize.
