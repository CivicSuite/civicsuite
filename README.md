...
- City-core generated package surfaces exist under the installer tree. The current canonical 0.1.2 artifacts for this run are preserved under `C:\Users\scott\OneDrive\Desktop\Claude\CivicSuite-city-core-caboose-item1\.agent-runs\2026-05-26-city-core-non-technical-installable\evidence\current-0.1.2-build-regenerated-2026-05-27-windows-admin-email-fix`; PR #183 is green at `804eb6c86e553e8263cf8ba6d8ced4426561beb1` with verify run `26493402566`, release-lockstep-gate run `26493402751`, and installer-cleanroom run `26493402568`. Release promotion still requires final audit-full evidence.
