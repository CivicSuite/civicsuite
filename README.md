...
- **`civiczone`, `civicplan`, `civicpermit`** â€” runtime foundations with bounded shipped surfaces; false v1.0.0 labels are being superseded by v0.2.0 recovery releases.
