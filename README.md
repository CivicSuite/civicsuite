...
|---|---:|---|
| City-core release cars | CivicCore plus 3 product repos | CivicCore v1.2.0 is the shared platform release. CivicRecords AI v1.7.3, CivicClerk v1.0.3, and CivicCode v1.0.8 are the city-core module cars. The city-core installer is beta-ready truth-reconciled after audit-full found zero unresolved Blocker or Critical findings. PR #183 is green for verify, release-lockstep-gate, Windows readiness, macOS beta readiness, Linux readiness, and Linux lifecycle; local first-run browser QA now covers Windows and Linux one-click artifacts. |
