# Tester Directive 040 - isolated host-Ollama startup retry rerun

## Goal

Rerun the Stage 3A isolated host-Ollama port gate after builder commit `0cc71aba436d9e46c2e6d7b651b42567ff31ea18` fixed uncaught `/api/tags` startup probe timeouts.

`TESTER-RESULT-039.md` proved the isolated server on `11435` eventually came up and listed `gemma4:e4b`, but readiness failed because the first 3-second `/api/tags` timeout escaped as an uncaught Python `TimeoutError`. This directive retests the same isolated endpoint path after timeout capture/retry.

## Required branch truth

- Repo: `CivicSuite/civicsuite`
- Branch: `stage-3a-baremetal-windows`
- Required minimum head: `0cc71aba436d9e46c2e6d7b651b42567ff31ea18`
- Builder fix under test: `0cc71aba436d9e46c2e6d7b651b42567ff31ea18`
- Prior result to read: `test-comms/TESTER-RESULT-039.md`
- Expected result file: `test-comms/TESTER-RESULT-040.md`
...
3. Confirm the checked-out commit is at or after `0cc71aba436d9e46c2e6d7b651b42567ff31ea18`.
4. Read `test-comms/TESTER-RESULT-039.md`.
...
12. If readiness fails, stop and report exact stdout/stderr/fix steps plus server evidence. Do not install.
13. If readiness passes, run install:

```powershell
python scripts\run-clerk-core-installer.py install --run-id stage3a-proven-suite-clean-machine-r16 --install-root installer\runtime\proven-suite-clean-machine-r16 --compose-project-suffix stage3a-proven-suite-clean-machine-r16 --port-offset 5000 --module civicrecords-ai --module civicclerk --module civiccode --module civiczone --module civicplan --module civicpermit --module civicaccess --module civicinspect --module civicgrants --module civicprocure --host-ollama --host-ollama-port 11435
```
...
```powershell
python scripts\run-clerk-core-installer.py verify --run-id stage3a-proven-suite-clean-machine-r16-verify --install-root installer\runtime\proven-suite-clean-machine-r16 --compose-project-suffix stage3a-proven-suite-clean-machine-r16 --port-offset 5000 --module civicrecords-ai --module civicclerk --module civiccode --module civiczone --module civicplan --module civicpermit --module civicaccess --module civicinspect --module civicgrants --module civicprocure --host-ollama --host-ollama-port 11435
```

16. If install and verify pass, inspect launcher config and live routes as in the prior proven-suite directives.
17. Write `test-comms/TESTER-RESULT-040.md` and push it to `stage-3a-baremetal-windows`.

## Required result evidence

`TESTER-RESULT-040.md` must include:

- exact branch head tested,
- confirmation `TESTER-RESULT-039.md` was read,
...
Push only `test-comms/TESTER-RESULT-040.md`. No source edits during the test run. No merge, tag, status promotion, or `modules.json` changes. Never touch any OneDrive path.
