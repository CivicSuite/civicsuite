...
REPOS: tuple[RepoSpec, ...] = (
    RepoSpec("civiccore", "CivicSuite/civiccore", "civiccore", "0.21.0", civiccore_required=None),
    RepoSpec(
        "civicrecords-ai",
    ...
    RepoSpec("civiccode", "CivicSuite/civiccode", "civiccode", "0.1.7", civiccore_required="0.21.0"),
